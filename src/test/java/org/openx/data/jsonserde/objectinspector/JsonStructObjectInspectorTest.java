...
public class JsonStructObjectInspectorTest {
  ...
  private static class StringField implements StructField {

    String fieldName;
    JsonStringJavaObjectInspector fieldObjectInspector;

    public StringField(String fieldName, JsonStringJavaObjectInspector fieldObjectInspector) {
